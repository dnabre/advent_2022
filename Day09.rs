...
impl Rope {
    ...
    fn new_tail_position(knot: &Position, head_knot: &Position) -> Position {
        ...
        if (head_knot_x -x).abs() !=1  || (head_knot_y -y).abs() != 1  {
...
fn part1() -> String {
    ...
    let  answer1 = visited.len().to_string();
    return answer1;
}
...
fn part2() -> String {
    ...
    let  answer2 = visited.len().to_string();
    return answer2;
}
